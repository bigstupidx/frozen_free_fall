...
const char * _audioRecorderPrepareToRecordFile( const char * filename, float frequency )
{
	...
	NSError *error = [[AudioRecorderManager sharedManager] prepareToRecordFile:file withFrequency:frequency];
	if( error )
