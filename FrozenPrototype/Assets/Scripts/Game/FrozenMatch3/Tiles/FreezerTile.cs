...
public class FreezerTile : NormalTile {
	...
	public override void InitComponent () {
		...
		cachedAnimation = cachedTransform.Find("Model").animation;
		tileModelRenderer = tileModelTransform.GetChild(2).renderer;
	...
	{	
		...
		{	
			...
			{
				if(freezerNeighbors[i].Tile != null && freezerNeighbors[i].Tile is TriggerTile)
				{
