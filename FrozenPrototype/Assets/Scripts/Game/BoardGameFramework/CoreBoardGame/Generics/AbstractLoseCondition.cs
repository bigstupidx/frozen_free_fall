...
{	
	...
	public event ConditionChecked OnLoseChecked;
	public event ConditionChecked OnNewMove;
	...
	{
//		LoadLevelButton.lastUnlockedLevel = Mathf.Max(LoadLevelButton.lastUnlockedLevel, Match3BoardRenderer.levelIdx + 1);
