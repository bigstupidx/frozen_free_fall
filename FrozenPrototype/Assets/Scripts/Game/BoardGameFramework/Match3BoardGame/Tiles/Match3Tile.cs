...
//			if (!waitingForOtherTile) {
	...
	public void AddScore() 
	{
		...
		if(ScoreSpawner.instance) {
			ScoreSpawner.instance.SpawnScore(WorldPosition, Points + TweaksSystem.Instance.intValues["MultipliedScore"] * (ScoreSystem.Instance.Multiplier - 1));
		}
	}
