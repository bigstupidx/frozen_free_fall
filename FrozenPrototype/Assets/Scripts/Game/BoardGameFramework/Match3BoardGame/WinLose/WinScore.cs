...
public class WinScore : AbstractWinCondition 
{
	...
	{
		for (int i = 1; i <= 3; ++i) {
			string key = "Level" + Match3BoardRenderer.levelIdx + "Star" + i;
	...
	protected override void Start()
	{
		...
		bestScore = UserManagerCloud.Instance.GetScoreForLevel(Match3BoardRenderer.levelIdx);//PlayerPrefs.GetInt("BestScore", 0);
