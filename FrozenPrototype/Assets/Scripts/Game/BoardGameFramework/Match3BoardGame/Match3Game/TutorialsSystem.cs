...
public class TutorialsSystem : MonoBehaviour
{
	...
	public void ShowTutorial()
	{
		...
		if (itemIdx >= 0) {
			// In level 8, since torch tutorial is hard to understand, we don't disable torch input to allow use to skip tutorial 
			if (gaveFreeItems && Match3BoardRenderer.levelIdx != 8) {
